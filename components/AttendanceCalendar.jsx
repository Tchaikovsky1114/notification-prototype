  ...
  return (
    <View key={'calendar'} style={{position:'relative'}}>
      ...
      <View style={{justifyContent:'center',alignItems:'center',marginTop:40,marginHorizontal:16,borderRadius:8,borderWidth:1,borderColor:'#c7c7c7'}}>
        ...
        <View style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',padding:16}}>
          <View style={{flex:1,justifyContent:'center',alignItems:'center',borderEndWidth:1,borderEndColor:'#c7c7c7'}}><NotoText>0H 0M 0S</NotoText><NotoText>이번달 누적</NotoText></View>
          <View style={{flex:1,justifyContent:'center',alignItems:'center',borderEndWidth:1,borderEndColor:'#c7c7c7'}}><NotoText>0H 0M 0S</NotoText><NotoText>이번달 초과</NotoText></View>
          <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><NotoText>기본그룹</NotoText><NotoText>잔여 출퇴근</NotoText></View>
        </View>
      </View>
      {
