      ...
      >
        ...
        >
          <Image
            ...
            source={{
              uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUd_xVsmeViKMvrtNOguehlTjA-vsqyn8fyQ&usqp=CAU',
            }}
          />
        </View>
        ...
        >
          <NotoText style={{ fontSize: 18, color: '#fff' }}>{title}</NotoText>
          <View
            style={{
              flexDirection: 'row',
          ...
          >
            ...
            <NotoText style={{ fontSize: 12, color: '#ccc' }}>
              {createdTime.month >= 10
                ? createdTime.month
                : '0' + createdTime.month}
              -{createdTime.day >= 10 ? createdTime.day : '0' + createdTime.day}{' '}
